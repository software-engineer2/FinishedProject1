...
<title>Cancel One-Way Reservation Part 2</title>
</head>
<body>
...
try {
	...
	if (Class.equalsIgnoreCase("Economy")) {
		out.print("Sorry, since your flight is economy, you are not allowed to cancel your ticket.");
	...
	out.print("You have been charged a cancellation fee of $50.");
	}
