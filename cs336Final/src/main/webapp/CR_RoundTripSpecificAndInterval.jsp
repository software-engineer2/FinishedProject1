...
<title>Customer Representative Round Trip Specific Date And Interval </title>
</head>
<body>
<%@ page import ="java.sql.*" %>
	...
	<br>
	<form method="post" action="CR_SortedRoundTrip.jsp">
	...
	<h3>To go to the return flight table please click submit</h3>
	
	<form method="post" action="CR_RoundTripSpecificAndIntervalPart2.jsp">
<input type="hidden" name="sortBy"
			value="<%=request.getParameter("sortFlight")%>" /> <input type="hidden"
			name="isFlexible"
			value="<%=request.getParameter("isFlexible")%>" /> <input
			type="hidden" name="departingAirport"
			value="<%=request.getParameter("departingAirport")%>" /> <input
			type="hidden" name="arrivingAirport"
			value="<%=request.getParameter("arrivingAirport")%>" /> <input
			type="hidden" name="departureDate"
			value="<%=request.getParameter("departureDate")%>" /> <input
			type="hidden" name="returnDate"
			value="<%=request.getParameter("returnDate")%>" /> <input
			type="submit" value="submit">
	</form>
