...
<title>Customer Representative Get Off Waiting List Check 4</title>
</head>
<body>
		...
		try {
		 SimpleDateFormat sdformat = new SimpleDateFormat("yyyy-MM-dd");
	      ...
	      if(currentD.compareTo(departureD) < 0) {
	  		...
	  		%>
	  		<a href='successCR.jsp'>The Link To Go Back</a>
	

	<%
	      } else {
	    	  out.print("Sorry, the flight has left already since the expected departure date was before the current date.");
	      }
