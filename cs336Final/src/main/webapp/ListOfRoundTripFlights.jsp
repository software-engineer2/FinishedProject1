...
<title>List of Round Trip Flights</title>
</head>
<body>
...
<%@ page import ="java.sql.*" %>
	...
	<h2>
		<b>List of All Round-Trip Flights </b>
	</h2>
	...
	try {
		...
		String roundTripFlightString = "SELECT flight_num, aTime, dTime, dep_airport, " +
	    		"arr_airport, 2letterid, operatingDays, price, class " 
	    		+ "FROM flight join FlightDates using(2letterid)"; 
	
		Statement stmt = con.createStatement();
			
		ResultSet result = stmt.executeQuery(roundTripFlightString);
	...
	<form method="post" action="RoundTripSpecificAndInterval.jsp">
		...
		<table>
		<tr>
				<td>Please Enter OneWay or RoundTrip again:</td>
			...
			<tr>
				<td>Return Date as YYYY-MM-DD</td>
