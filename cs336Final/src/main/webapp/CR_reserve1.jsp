...
<title>Customer Representative Reserve Part 1</title>
</head>
<body>

<br>
	<form method="post" action = "CR_reserve2.jsp">
		<!-- hidden type name trip_type = "1"-->
		
		<table>
			<tr>
				<td>Please enter the cid of your customer</td>
		...
		<table>
			<tr>
				<td>Please Enter the Flight Number your customer wants to reserve</td>
