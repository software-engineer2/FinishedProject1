...
<title>Get Off Waiting List Check</title>
</head>
<body>
	...
	try {
		...
		if (intOfSeats == count1) {
			...
			out.println("Sorry. There are still no available seats. Click the link below to go back " +
					"and check on your other waitlisted flights if applicable.");
						
						 out.println("<a href='success.jsp'>Go back</a>");	
		} else {
			...
			out.println("There is a seat available. Select what class you were waitlisted " +
					"for and click submit to go forward.");
						
			%>
			<br>
			<form method="post" action = "GetOffWaitingListCheck2.jsp">
