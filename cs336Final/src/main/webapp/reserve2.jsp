...
<%
	...
	try {
		...
		if (intOfSeats == count1) {
			...
			out.println("The flight is full. You are being directed to the waitlist. "+ "<p align='left'> <a href='Waitlist.jsp'></a>  </p>");
			%>
	...
	<br>
	<form method="post" action = "reserve3.jsp">
		<!-- hidden type name trip_type = "1"-->
